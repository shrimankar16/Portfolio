...
function SettingsProvider({ children }) {
    _s();
    const [effects3D, setEffects3D] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsProvider.useEffect": ()=>{
            ...
            const onChange = {
                "SettingsProvider.useEffect.onChange": (e)=>setReducedMotion(e.matches)
            }["SettingsProvider.useEffect.onChange"];
            mq.addEventListener("change", onChange);
            // Default 3D off on small / low-power devices, on elsewhere.
            const coarse = ("TURBOPACK compile-time value", "object") !== "undefined" && (window.matchMedia("(pointer: coarse)").matches || window.innerWidth < 768);
            setEffects3D(!coarse);
            return ({
                "SettingsProvider.useEffect": ()=>mq.removeEventListener("change", onChange)
            })["SettingsProvider.useEffect"];
        }
    }["SettingsProvider.useEffect"], []);
...
_s(SettingsProvider, "zuTX67Asy4JpziqeIfCuDWwMCLY=");
_c = SettingsProvider;
...
//# sourceMappingURL=_1s47ldp._.js.map